...
export default function LandingPage({ restaurant }: LandingPageProps) {
  ...
  return (
    <div className="bg-slate-950 text-white font-sans min-h-screen selection:bg-orange-500 selection:text-white">
      {/* Background decoration */}
      <div className="absolute top-0 left-1/4 w-96 h-96 bg-orange-600/10 rounded-full blur-[120px] pointer-events-none z-0" />
      <div className="absolute top-1/3 right-1/4 w-96 h-96 bg-green-500/10 rounded-full blur-[120px] pointer-events-none z-0" />
      ...
      <header className="relative z-10 max-w-7xl mx-auto px-6 py-6 flex items-center justify-between border-b border-white/5">
        <div className="flex items-center gap-2">
          ...
          <span className="font-extrabold text-2xl tracking-tight bg-gradient-to-r from-white via-slate-100 to-slate-300 bg-clip-text text-transparent">
            Menu<span className="text-orange-500">Go</span>
          </span>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <Link 
            href="/onboarding" 
            className="bg-orange-500 hover:bg-orange-600 active:scale-95 text-white px-5 py-2.5 rounded-xl text-sm font-black transition-all shadow-lg shadow-orange-500/25 flex items-center gap-1.5"
          >
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-6 pt-16 pb-24 grid md:grid-cols-12 gap-12 items-center">
        <div className="md:col-span-7 space-y-8 text-left">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/5 border border-white/10 text-orange-400 text-xs font-black tracking-wider uppercase">
          ...
          <h1 className="text-5xl lg:text-7xl font-black tracking-tight leading-[1.05] bg-gradient-to-br from-white via-slate-100 to-slate-400 bg-clip-text text-transparent">
            Convert Tables Into <span className="bg-gradient-to-r from-orange-400 to-amber-300 bg-clip-text text-transparent">Instant Sales.</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-2">
            <Link 
              href="/onboarding" 
              className="bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 text-white font-black text-lg px-8 py-4 rounded-2xl shadow-xl shadow-orange-500/20 text-center transition-all active:scale-98 flex items-center justify-center gap-2 group"
            >
        ...
        <div className="md:col-span-5 relative flex justify-center">
          <div className="absolute inset-0 bg-gradient-to-tr from-orange-500/20 to-green-500/20 rounded-full filter blur-[80px] pointer-events-none opacity-60" />
            ...
            <div className="space-y-4">
              ...
              <div className="bg-slate-950/80 rounded-2xl p-4 border border-white/5 space-y-3">
                ...
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="text-orange-400 font-black">42 sold</span>
                </div>
                <div className="flex items-center justify-between text-sm">
                  <span className="text-slate-300 font-extrabold">2. Butter Naan</span>
                  <span className="text-orange-400 font-black">89 sold</span>
                </div>
              </div>
      ...
      <section id="demo" className="relative z-10 max-w-7xl mx-auto px-6 py-20 border-t border-white/5">
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          <h2 className="text-4xl md:text-5xl font-black tracking-tight">
            See the Customer Experience in <span className="bg-gradient-to-r from-orange-400 to-amber-300 bg-clip-text text-transparent">Real-Time.</span>
          </h2>
          ...
          <div className="lg:col-span-5 space-y-8 text-left">
            <div className="space-y-6">
              <div className="flex gap-4">
                <div className="w-12 h-12 rounded-2xl bg-orange-500/10 border border-orange-500/20 flex-shrink-0 flex items-center justify-center text-orange-400">
                  <ScanLine size={24} />
                </div>
                <div>
              ...
              <div className="flex gap-4">
                <div className="w-12 h-12 rounded-2xl bg-amber-500/10 border border-amber-500/20 flex-shrink-0 flex items-center justify-center text-amber-400">
                  <ShoppingBag size={24} />
                </div>
                <div>
            ...
            <div className="p-6 bg-slate-900/40 rounded-3xl border border-white/5 space-y-4">
              <h4 className="font-extrabold text-lg text-white flex items-center gap-2">
                <Sparkles className="text-orange-400" size={18} /> Mock Menu loaded:
              </h4>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-slate-800 rounded-xl flex items-center justify-center text-orange-400 font-black text-lg shadow-inner">
                  YC
                </div>
                <div>
              ...
              <div className="flex-1 flex flex-col overflow-y-auto overflow-x-hidden pt-6 bg-slate-950 pb-20 relative text-slate-900 font-sans select-none scrollbar-none">
                ...
                <div className="bg-white p-4 pt-6 border-b border-gray-100 flex items-center justify-between">
                  ...
                  <div className="relative">
                    ...
                    {totalCartCount > 0 && (
                      <span className="absolute -top-1 -right-1 bg-orange-500 text-white text-[9px] font-black w-4.5 h-4.5 rounded-full flex items-center justify-center animate-bounce">
                        {totalCartCount}
                      </span>
                    )}
                  </div>
                ...
                {/* Menu Item Cards in Mobile */}
                <div className="flex-1 bg-gray-50/60 p-3 space-y-3">
                  {filteredItems.map(item => {
                    ...
                    return (
                      <div 
                        key={item.id}
                        className="bg-white rounded-2xl border border-gray-100/80 flex p-2.5 gap-3 shadow-[0_4px_12px_rgba(0,0,0,0.015)] relative overflow-hidden"
                      >
                        {/* Image */}
                        <div className="relative w-24 h-24 rounded-xl overflow-hidden flex-shrink-0 bg-gray-100">
                          ...
                          />
                          {item.isPopular && (
                            <div className="absolute top-1 left-1 bg-white/95 text-green-500 px-1 py-0.5 rounded text-[8px] font-black shadow-sm">
                              POPULAR
                            </div>
                          )}
                        </div>
                          ...
                          <div>
                            <div className="flex items-start justify-between">
                              <div className="flex items-center gap-1">
                                ...
                                {isSpicy && <Flame size={12} className="text-red-500 fill-red-500 flex-shrink-0" />}
                              </div>
                              <div className={`w-3.5 h-3.5 border rounded flex items-center justify-center flex-shrink-0 ${item.isVeg ? 'border-green-500' : 'border-red-500'}`}>
                                <div className={`w-1.5 h-1.5 rounded-full ${item.isVeg ? 'bg-green-500' : 'bg-red-500'}`} />
                              </div>
                            </div>
                            <p className="text-gray-400 text-[10px] leading-snug line-clamp-2 mt-1">{item.description}</p>
                          </div>
                              ...
                              {quantity > 0 ? (
                                <div className="flex items-center gap-1.5 bg-gray-50 border border-gray-100 rounded-lg p-0.5">
                                  <button 
                                    ...
                                    className="w-5.5 h-5.5 bg-white rounded flex items-center justify-center text-orange-500 shadow-sm border border-gray-100 active:scale-90"
                                  >
                                    <Minus size={10} strokeWidth={3} />
                                  </button>
                                  <span className="font-black text-gray-900 text-xs min-w-4 text-center">{quantity}</span>
                                  <button 
                                    onClick={() => updateCart(item.id, 1)}
                                    className="w-5.5 h-5.5 bg-orange-500 rounded flex items-center justify-center text-white active:scale-90"
                                  >
                                ...
                                <button 
                                  onClick={() => updateCart(item.id, 1)}
                                  className="w-6 h-6 bg-orange-500 text-white rounded-lg flex items-center justify-center shadow-md shadow-orange-500/20 active:scale-90 transition-transform"
                                >
                ...
                {totalCartCount > 0 && (
                  <div className="absolute bottom-4 left-3 right-3 bg-white p-3 rounded-2xl border border-gray-100 shadow-lg shadow-black/10 flex items-center justify-between z-20 animate-fade-in-up">
                    ...
                    <button 
                      ...
                      className="bg-orange-500 hover:bg-orange-600 text-white font-black text-xs px-4 py-2 rounded-xl flex items-center gap-1"
                    >
      ...
      <section id="features" className="relative z-10 max-w-7xl mx-auto px-6 py-24 border-t border-white/5 bg-slate-900/20 rounded-t-[50px]">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-slate-900/40 p-8 rounded-3xl border border-white/5 space-y-4 hover:border-orange-500/30 transition-all duration-300 group">
      ...
      <section id="pricing" className="relative z-10 max-w-7xl mx-auto px-6 py-24 border-t border-white/5">
        <div className="text-center max-w-2xl mx-auto mb-16 space-y-4">
          <span className="text-orange-500 font-black text-xs tracking-wider uppercase bg-orange-500/10 px-3 py-1 rounded-full">Pricing Plans</span>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          {/* Monthly Growth Plan */}
          <div className="bg-slate-900/80 p-8 rounded-3xl border-2 border-orange-500 flex flex-col justify-between relative shadow-xl shadow-orange-500/5">
            <div className="absolute top-0 right-8 -translate-y-1/2 bg-orange-500 text-white text-[10px] font-black px-3 py-1 rounded-full uppercase tracking-wider">
              Most Popular
            </div>

            <div>
              <h3 className="text-lg font-black text-white flex items-center gap-2">
                Monthly Growth <Sparkles size={16} className="text-orange-400 animate-spin-slow" />
              </h3>
              <p className="text-orange-400 text-xs mt-1 font-extrabold uppercase tracking-wide">Double line value</p>
            ...
            <div className="pt-8">
              <Link 
                href="/onboarding"
                className="block text-center w-full bg-orange-500 hover:bg-orange-600 active:scale-98 text-white font-black py-3.5 rounded-xl text-sm transition-all shadow-lg shadow-orange-500/20"
              >
                Go Growth (Monthly)
              </Link>
            </div>
      ...
      <footer className="relative z-10 max-w-7xl mx-auto px-6 py-12 border-t border-white/5 text-center text-slate-500 text-xs font-semibold flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-2">
          <div className="w-6 h-6 bg-orange-500 rounded-md flex items-center justify-center text-white text-[10px] font-black">
            MG
          </div>
          <span className="font-extrabold text-sm text-slate-300">Menu<span className="text-orange-500">Go</span></span>
        </div>
